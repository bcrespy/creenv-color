...
class Color extends Vector {
  ...
  /**
   * Returns a 3 dimentional array [hue, saturation, luminosity] based on the 
   * HSL representation of this rgb color. 
   * Adapted from
   * [https://axonflux.com/handy-rgb-to-hsl-and-rgb-to-hsv-color-model-c]
   *
   * @return {Array.<number>} [h, s, v]
   */
  get hsl (){
    let r = this.r/255,
        g = this.g/255,
  ...
  /**
   * returns a 3 components array corresponding to this color representation 
